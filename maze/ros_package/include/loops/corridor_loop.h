...
private:
    ...
    static constexpr int CROSSROAD_CONFIRM_TICKS  = 50;    // ticks crossroad must hold before stopping (~60 ms)
    static constexpr int CROSSROAD_INHIBIT_TICKS  = 150;   // ticks after a turn before crossroad detection re-enables (~3 s)
    static constexpr int CROSSROAD_COOLDOWN_TICKS = 150;   // ticks after a turn before crossroad detection resumes (~3 s)
